...
ENUM_TYPE_NAMES: dict[type, str] = {
    ...
    ComplianceIssueCategory: "compliance_issue_category",
    ComplianceIssueSeverity: "compliance_issue_severity",
    ComplianceIssueStatus: "compliance_issue_status",
    ...
    SupportTicketAuthorKind: "support_ticket_author_kind",
    SupportTicketPriority: "support_ticket_priority",
